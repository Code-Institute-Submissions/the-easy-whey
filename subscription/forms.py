...
class OrderItemsForm(forms.Form):
    ...
    def clean(self):
        ...
        cookies_and_cream_validation = cleaned_data['cookies_and_cream_quantity']
        total_quantities = [chocolate_quantity_validation,banana_quantity_validation,strawberry_quantity_validation,cookies_and_cream_validation]
