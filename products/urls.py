...
urlpatterns = [
    ...
    path('product/admin/edit/item/<item_id>/ingredient/<ingredient_id>', views.admin_edit_item_ingredient, name="admin_edit_item_ingredient"),
    path('product/admin/edit/', views.admin_edit_list, name="admin_edit_list"),
    path('product/admin/edit/item/delete_ingredient/<ingredient_id>', views.delete_ingredient, name="delete_ingredient"),
